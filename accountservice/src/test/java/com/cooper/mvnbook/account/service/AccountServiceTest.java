...
public class AccountServiceTest {
			...
			throws Exception
	{
		...
		TestCase.assertEquals( 1, msgs.length );
		TestCase.assertEquals( "Please Activate Your Account", msgs[0].getSubject() );
		...
		try
		{
			...
			TestCase.fail( "Disabled account shouldn't be able to log in." );
		}
		...
		try
		{
			...
			TestCase.fail( "Password is incorrect, shouldn't be able to login." );
		}
		catch ( AccountServiceException e )
		{
		}
